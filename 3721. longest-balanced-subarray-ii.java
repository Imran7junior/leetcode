...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        // Example 1
        int[] nums1 = {2, 5, 4, 3};
        System.out.println(sol.longestBalanced(nums1));  // Expected: 4
        
        // Example 2
        int[] nums2 = {3, 2, 2, 5, 4};
        System.out.println(sol.longestBalanced(nums2));  // Expected: 5
        
        // Example 3
        int[] nums3 = {1, 2, 3, 2};
        System.out.println(sol.longestBalanced(nums3));  // Expected: 3
    }
}