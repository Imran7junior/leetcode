class Solution {
    ...
    public static void main(String[] args) {
        ...
        List<Boolean> output1 = sol1.getResults(queries1);
        System.out.println("Example 1: queries=[[1,2],[2,3,3],[2,3,1],[2,2,2]]");
        ...
        List<Boolean> output2 = sol2.getResults(queries2);
        System.out.println("Example 2: queries=[[1,7],[2,7,6],[1,2],[2,7,5],[2,7,6]]");
        System.out.println("Output: " + output2);
        System.out.println("Expected: [true, true, false]");
    }
}