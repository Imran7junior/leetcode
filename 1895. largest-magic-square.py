...
if __name__ == "__main__":
    ...
    output1 = solution.largestMagicSquare(grid1)
    print(f"Test 1: grid = [[7,1,4,5,6],[2,5,1,6,4],[1,5,4,3,2],[1,2,7,3,4]]")
    print(f"Output: {output1}, Expected: 3")
    
    # Test case 2
    grid2 = [[5,1,3,1],[9,3,3,1],[1,3,3,8]]
    output2 = solution.largestMagicSquare(grid2)
    print(f"Test 2: grid = [[5,1,3,1],[9,3,3,1],[1,3,3,8]]")
