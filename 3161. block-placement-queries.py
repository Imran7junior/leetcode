...
if __name__ == "__main__":
    ...
    output1 = sol.getResults(queries1)
    print(f"Example 1: queries={queries1}")
    print(f"Output: {output1}")
    print(f"Expected: [False, True, True]")
    print()
    
    # Example 2
    sol2 = Solution()
    queries2 = [[1,7],[2,7,6],[1,2],[2,7,5],[2,7,6]]
    output2 = sol2.getResults(queries2)
    print(f"Example 2: queries={queries2}")
