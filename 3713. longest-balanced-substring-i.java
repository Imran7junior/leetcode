class Solution {
    ...
    public static void main(String[] args) {
        ...
        // Example 1
        String s1 = "abbac";
        System.out.println(sol.longestBalanced(s1));  // Expected: 4
        
        // Example 2
        String s2 = "zzabccy";
        System.out.println(sol.longestBalanced(s2));  // Expected: 4
        
        // Example 3
        String s3 = "aba";
        System.out.println(sol.longestBalanced(s3));  // Expected: 2
    }
}